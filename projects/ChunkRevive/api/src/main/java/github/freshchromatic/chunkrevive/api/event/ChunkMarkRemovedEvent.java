...
public final class ChunkMarkRemovedEvent extends Event {
    ...
    public ChunkMarkRemovedEvent(MarkedChunkSnapshot mark, String sourcePlugin,
                                 Optional<UUID> actor, Optional<String> correlationId) {
        this.mark = mark;
